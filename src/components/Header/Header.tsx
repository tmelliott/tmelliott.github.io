...
export default function Header() {
    ...
    return (
      <motion.header layoutId="headerContainer">
        <div className="bg-gray-50 flex flex-col items-center justify-center mt-[30vh] relative z-20">
          <Link
            href="/"
            className="absolute rounded-full -translate-y-1/2 top-0 z-20 border-8 border-gray-50"
          >
            <Image
              src="/photo.jpg"
  ...
  return (
    <header className="h-[50px] mt-[50px] bg-gray-50">
      <div className="fixed z-30 bg-slate-800 top-0 w-full h-[50px]">
        <div className="fixed z-30 top-[50px] w-full flex flex-col justify-end h-[50px] bg-opacity-80 bg-gradient-to-b from-slate-50 via-slate-50 to-transparent">
          <div className="absolute top-0 w-full flex items-center justify-start gap-6 px-4 h-[100px] z-50 -translate-y-1/2">
            <Link
              href="/"
              className="rounded-full z-20 border-4 border-gray-50"
            >
              <Image
                src="/photo.jpg"
                className="rounded-full z-30"
